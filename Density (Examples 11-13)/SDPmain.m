...
cvx_begin sdp quiet
    ...
    subject to
        ...
        trace(V) >= 5;
        %psidef(0,pi/2,nv_omega,nv_theta)' * V * psidef(0,pi/2,nv_omega,nv_theta)==0;
        %V+psidef(0,pi/2,nv_omega,nv_theta)*psidef(0,pi/2,nv_omega,nv_theta)'>=0.0001 * eye(size_v);
cvx_end
